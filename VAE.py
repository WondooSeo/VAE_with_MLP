...
path_dir = "C:/Users/mirac/Documents/Pycharm/VAE/Aug2_Dataset_Thorax/"
...
if (os.path.exists(decoder_path)):
    ...
    decoder_outputs = layers.Conv2DTranspose(3, 8, activation="sigmoid", padding="same")(x)
...
plt.imshow(np.reshape(x_decoded, (128, 128, 3)))
plt.axis('off')
plt.show()
